...
export function ProjectCard({ title, description, tags, githubUrl, stars, language }: ProjectCardProps) {
  ...
  return (
    <Card 
      className="group relative overflow-hidden transition-all border-gradient cursor-pointer h-full flex flex-col"
      ...
      <CardHeader className="relative flex-shrink-0">
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            <CardTitle className="text-xl group-hover:bg-gradient-to-r group-hover:from-slate-700 group-hover:to-gray-700 dark:group-hover:from-slate-300 dark:group-hover:to-gray-300 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 line-clamp-2">
              {title}
            </CardTitle>
